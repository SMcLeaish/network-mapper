...
openssl x509 -req -in $DIR/server.csr -CA $DIR/rootCA.pem -CAkey $DIR/rootCA.key -CAcreateserial -out $DIR/server.crt -days 365 -sha256 -extensions v3_req -extfile $DIR/san.cnf
