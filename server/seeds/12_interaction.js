    ...
    return knex('interaction').del()
      .then(function () {
        return knex('interaction').insert([
          ...
          {weight: 1, id_entity_1: 6, id_entity_2: 7, id_event: 6},
          {weight: 1, id_entity_1: 7, id_entity_2: 8, id_event: 7},
          {weight: 1, id_entity_1: 8, id_entity_2: 9, id_event: 8},
          {weight: 1, id_entity_1: 9, id_entity_2: 10, id_event: 9},
          {weight: 1, id_entity_1: 10, id_entity_2: 1, id_event: 10},
          {weight: 1, id_entity_1: 2, id_entity_2: 8, id_event: 11},
          {weight: 1, id_entity_1: 3, id_entity_2: 9, id_event: 12},
          {weight: 1, id_entity_1: 4, id_entity_2: 10, id_event: 13},
          {weight: 1, id_entity_1: 5, id_entity_2: 8, id_event: 14},
          {weight: 1, id_entity_1: 6, id_entity_2: 9, id_event: 15},
          {weight: 1, id_entity_1: 7, id_entity_2: 10, id_event: 16},
